...
class Order(db.Model):
    ...
    ingredient_detail = db.relationship('IngredientDetail', backref=db.backref('ingredient_detail'))
    beverage_detail = db.relationship('BeverageDetail', backref=db.backref('beverage_detail'))
